...
class FoodLike extends React.Component{
    ...
    componentDidMount(){
        ...
        axios.get(Service.getServerHostName() + "/api/food-post/" + this.props.match.params.userId)
        .then(res => {
    ...
    render(){
        return(
            ...
            <div className="text-center title-header">DANH SÁCH CÁC BÀI VIẾT BẠN ĐÃ ĐĂNG</div>
            <div className="row">
            {
