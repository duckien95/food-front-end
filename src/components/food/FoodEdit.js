        ...
        .then(
            res => {
                ...
                this.setState({
                    ...
                    detail: this.food.detail_category_id
                })
            }
        ).then(
            res => {
            ...
            res =>  {
                axios.get(Service.getServerHostName() + "/api/category/detail").then(res => {
                    ...
                    var cate_id = this.food.category_id;
                    // console.log(res.data.data[cate_id]);
                    // console.log('cate_id = ' + this.food.category_id);
					...
					<div className="col-sm-10">
						<div className="form-row">
							...
							<div className="col-md-6 mb-3">
						  	...
						  	<div className="col-md-6 mb-3">
								<select className="custom-select" name="detail" onChange={this.handleDetailChange} onInvalid={this.onInvalid} required>
								<option value="" disabled selected>Chi tiết</option>
								{
									this.state.cateDetail.map((ctd, index) =>
                                        this.food.detail_category_id === ctd.detail_id ?
